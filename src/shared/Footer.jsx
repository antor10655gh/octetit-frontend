...
const LINKS = [
  ...
  {
    title: 'Resource',
    items: ['Blog', 'Help Center', 'Knowledge Base']
  }
];
      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography className="mb-6">
            ...
            <p className="text-sm text-gray-500 pr-6 pt-3">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti
              molestiae blanditiis consectetur quae non laudantium nobis odio
              maxime consequatur inventore minima illo doloremque quasi.
            </p>
            <Subscribe />
          </Typography>
